...
export default function Example() {
  const steps = useMemo(
    () => [
      ...
      { label: "Step 2", content: "<button>HI</button>" },
      { label: "Step 3", content: "<button>HI</button>" },
      { label: "Step 4", disabled: true, content: "<button>HI</button>" },
      { label: "Step 5", content: "<button>HI</button>" },
      { label: "Step 6", content: "<button>HI</button>" },
    ],
    []
  );
  // useStepper
  const { state, stepperProps, stepsProps, progressProps, nextStep, prevStep } =
    useStepper({
      steps,
    });
              ...
              {({ close }) => (
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid gap-8 bg-orange-50 p-7 lg:grid-cols-2">
                    <nav
                      className="my-4 w-100 grid grid-cols-6 relative"
                      {...stepperProps}
                    >
