...
import ConnectWallet from "@/components/create-wallet";

import { Popover, Transition } from "@headlessui/react";
import { BTC, ETH, SOL, TRX } from "@ledgerhq/crypto-icons-ui/react";
import { PlusCircleFill } from "@ledgerhq/icons-ui/react";
...
import {
  ...
  saveRegistration,
  setRegistrations,
} from "@/lib/webauthn/state";

import SiweStep from "./aa-siwe";
  ...
  return (
    <>
      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
        <div className="relative gap-8 bg-orange-50 p-7 justify-center">
         {/* <p> {wallet?.getAddress()!}</p> */}
          <SiweStep address={wallet?.getAddress()!} goToStep={goToStep}></SiweStep>
        ...
        <div className="bg-gray-50 p-4">
          ...
          >
            <span className="flex items-center">
              <span className="text-sm font-medium text-gray-900">Next</span>
            </span>
            <span className="block text-sm text-gray-500">
              Create WalletPass Key{" "}
            </span>
          </a>
        </div>
      </div>
...
const Step3 = () => {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
        <div className="relative gap-8 bg-orange-50 p-7">
          <button
            onClick={async () => {
              await register(wallet?.getAddress()!);
            }}
            className="-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
          >
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-900">
                Create WalletPass Passkey for: {wallet?.getAddress()!}
              </p>
              <p className="text-sm text-gray-500" id="registrations">
        ...
        <div className="bg-gray-50 p-4">
          <a
            onClick={async () => {
              authenticate({ conditionalMediation: true })
                .then(console.log)
